...
const StudentSettings = () => {
	...
	const initialProfileState = {
		...
		phonenumber: '',
		gender: '',
		// Address is a subdocument in the student model
		address: {
			street: '',
			city: '',
			state: '',
	...
	const saveProfile = async e => {
		...
		try {
			...
			// Top-level fields
			['username', 'fullname', 'email', 'gender'].forEach(key => {
			...
			await safeApiCall(updateStudentProfile, payload);
	...
	const changePassword = async e => {
		...
		try {
			...
			await safeApiCall(changeStudentPassword, payload);
