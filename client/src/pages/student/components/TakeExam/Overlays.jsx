    ...
    <div className="start-screen">
        ...
        <div className="start-card">
            <div style={{ marginBottom: 24 }}>
                ...
                <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>You are about to begin the exam.</p>
            </div>
            ...
            <div className="info-grid">
                ...
                <div className="info-item">
                    ...
                    <strong>{(submission.questions || []).reduce((sum, q) => sum + q.max_marks, 0)}</strong>
                </div>
            </div>
            ...
            <button onClick={onStart} className="nav-btn primary btn-large">
                🚀 Start Exam
            </button>
        </div>
    </div>
...
export const ViolationOverlay = ({ type, onAcknowledge }) => (
    <div className="overlay-backdrop">
        <div className="overlay-card">
            ...
            <h2 className="overlay-title" style={{ color: 'var(--error)' }}>Violation Detected</h2>
        ...
        <div className="overlay-card">
            ...
            <div style={{ 
                ...
                <div style={{ textAlign: 'center' }}>
                    <strong style={{ display: 'block', fontSize: '1.25rem' }}>{stats.answered}</strong>
                    <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Answered</span>
                </div>
                <div style={{ textAlign: 'center' }}>
                    <strong style={{ display: 'block', fontSize: '1.25rem', color: 'var(--warning)' }}>{stats.review}</strong>
                    <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Marked</span>
                </div>
                <div style={{ textAlign: 'center' }}>
                    <strong style={{ display: 'block', fontSize: '1.25rem', color: 'var(--text-muted)' }}>{stats.unanswered}</strong>
            ...
            <div className="overlay-actions">
                ...
                <button onClick={onConfirm} className="nav-btn primary" style={{ background: 'var(--error)' }}>
                    Yes, Submit Exam
                </button>
            </div>
        </div>
