				...
				<main style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
					...
					>
						<KPI
							...
							color="#6366f1"
							subtitle={`${data.exams?.totalEnrolled ?? 0} enrolled`}
						/>
						<KPI
							label="Live Exams"
							value={data.exams?.live ?? 0}
							color="#10b981"
								...
								{loading ? (
									...
									(data.recentSubmissions || []).map(s => (
										...
										>
											...
											>
												<StatusBadge
													status={s.status ?? s.grade ?? 'pending'}
												/>
									...
									(data.examsToReview || []).map(e => (
										...
										>
											...
											>
												...
												>
													{e.submissionsCount ?? 0} submissions
												</div>
												<div
													style={{
														background:
															'linear-gradient(90deg,#eef2ff,#eef6ff)',
														color: 'var(--primary)',
														fontWeight: 800,
														padding: '6px 10px',
														borderRadius: 999,
