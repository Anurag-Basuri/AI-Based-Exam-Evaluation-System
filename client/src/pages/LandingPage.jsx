...
const LandingPage = () => {
    ...
    const features = [
        {
			...
			description: 'Free‑form answers are graded by the evaluation service with rule checks and similarity signals for repeatable results.',
			icon: image1
		},
        {
			title: 'Exam & Question Management',
			description: 'Create exams, maintain a question bank, and organize assessments through dedicated routes and controllers.',
			icon: image2
		},
        {
			title: 'Submissions & Results',
			description: 'Students submit once and get timely results. Results are easy to review and revisit.',
			icon: image3
		},
        {
			title: 'Issue Reporting',
			description: 'Students and teachers can report issues in‑app and track them to resolution.',
			icon: image4
		},
    ];
    ...
    // Unified auth navigation (now includes role in query string)
