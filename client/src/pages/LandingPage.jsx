                ...
                >
                    ...
                    >
                        {isAuthenticated ? (
                            <>
                                <button
                                    onClick={() => navigate(role === 'teacher' ? '/teacher/exams' : '/student/exams')}
                            ...
                            <>
                                <button onClick={onGetStarted} aria-label="Get Started" style={styles.buttonPrimary}>
                                    Get Started
                                </button>
                                <button onClick={onLearnMore} aria-label="Learn More" style={styles.buttonSecondary}>
                                    How it works
                                </button>
                            </>
                        )}
                ...
                >
                    <div style={styles.infoCard}>
                        ...
                        <div style={{ marginTop: 12 }}>
                            <button onClick={() => navigate('/teacher/exams')} style={styles.buttonTertiary}>
                                Open exam manager
                            </button>
                        </div>
                    </div>
                    <div style={styles.infoCard}>
                        ...
                        <div style={{ marginTop: 12 }}>
                            <button onClick={() => navigate('/student/exams')} style={styles.buttonTertiary}>
                                Open student exams
                            </button>
                        </div>
                    </div>
